...
// var test = [0, 1 ,2, 3];
// for (var i = 0; i < 10; i++) {
//   var output = Math.floor(Math.random() * test.length);
//   console.log(output);
// }

// Random Idea One - thisArray
var randomIdeaOne = Math.floor(Math.random() * thisArray.length);
console.log(thisArray[randomIdeaOne]);

// Random Idea Two - thatArray
var randomIdeaTwo = Math.floor(Math.random() * thatArray.length);
console.log(thatArray[randomIdeaTwo]);
